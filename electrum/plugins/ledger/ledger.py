...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Omotenashicoin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Omotenashicoin mode")) from e
                raise e
...
class LedgerPlugin(HW_PluginBase):
    ...
    def setup_device(self, device_info, wizard, purpose):
        ...
        client.get_xpub("m/44'/341'", 'standard') # TODO replace by direct derivation once Nano S > 1.1
